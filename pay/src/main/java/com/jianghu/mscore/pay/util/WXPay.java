...
public class WXPay {
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
        ...
        reqData.put("sign", WXPayUtil.generateSignature(reqData, config.getWxKey(), this.signType));
        return reqData;
    }
    ...
    public boolean isResponseSignatureValid(Map<String, String> reqData) throws Exception {
        ...
        return WXPayUtil.isSignatureValid(reqData, this.config.getWxKey(), this.signType);
    }
    ...
    public boolean isPayResultNotifySignatureValid(Map<String, String> reqData) throws Exception {
        ...
        return WXPayUtil.isSignatureValid(reqData, this.config.getWxKey(), signType);
    }

...
public class DefaultAclInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o) throws Exception {
        ...
        String scopeId;
        AppThreadCache.setScopeId(StringUtils.isEmpty(scopeId = httpServletRequest.getHeader(applicationConstant.scopeId)) ? "1" : scopeId);
        ...
        if (!Objects.equals("cs-authority", applicationConstant.serviceName)
            ...
            AppThreadCache.setExtraData(null);
        }
